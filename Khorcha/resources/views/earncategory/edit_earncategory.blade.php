    ...
    <div class="col-md-12">
        ...
        <div class="card ">
            ...
            <div class="card-header">
                <div class="card-title text-center">Edit Earn-Category Form <br>
            ...
            <div class="card-body">
                <form action="{{ url('edit_earncategory_post') }}" method="post">
                    @csrf
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Name</label>
                                        <input type="hidden" name="earncategory_id" value="{{ $earncategory->id }}">
                                        <input type="text" name="name" class="form-control" value="{{ $earncategory->name }}">
                                        @if($errors->has("name"))
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Remarks</label>
                                        <input type="text" name="remarks" class="form-control" value="{{ $earncategory->remarks }}">
