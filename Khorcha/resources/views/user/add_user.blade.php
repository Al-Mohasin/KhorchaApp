                        ...
                        <div class="col-md-10">
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-12 text-center">
                                    <img id="previewimage" src="{{ asset('uploads') }}/user/avatar.jpg" style="width:400px; border:2px solid #ddd" />
                                </div>
                            </div>
                            <!-- / photo upload =============================-->

                            <div class="text-center mt-3">
                                <button type="submit" class="myButtonBig">Submit Register</button>
                            </div>
