...
<li class="nav-item"><a href="#">Add Paid</a></li>
@endsection
    ...
    <div class="col-md-12">
        ...
        <div class="card ">
            ...
            <div class="card-header">
                <div class="card-title text-center">Add Paid Form <br>
            ...
            <div class="card-body">
                <form action="{{ url('add_paid_post') }}" method="post">
                    @csrf
