    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-header">
                <div class="card-title text-center">Monthly Summary List : <span style="color:var(--bc1)">{{ $running_month_name }} </span> <br>
                    <a href="{{ url('all_estimate') }}" class="myButtonSmall">All Estimate</a>
                ...
                <div class="table-responsive">
                    <table id="my_datatable" class="display table table-bodered able-striped table-hover">
                        ...
                        <tfoot>
                            ...
                            {{-- <tr>
                                <th colspan="5" class="text-center">Total Savings :
                                    {{ $earn_total - $paid_total }}
                                </th>
                            </tr> --}}
                        </tfoot>
