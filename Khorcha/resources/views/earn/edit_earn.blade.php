...
<li class="separator"><i class="fa fa-chevron-right"></i></li>
<li class="nav-item"><a href="#">Edit Earn</a></li>
@endsection
    ...
    <div class="col-md-12">
        ...
        <div class="card ">
            ...
            <div class="card-header">
                <div class="card-title text-center">Edit Earn Form <br>
                    <a href="{{ url('all_earn') }}" class="myButtonSmall">All Earn</a>
                </div>
            </div>
            ...
            <div class="card-body">
                <form action="{{ url('edit_earn_post') }}" method="post">
                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="earncategory_id">
                                            ...
                                            @foreach ($earn_category as $category)
                                                <option value="{{ $category->id }}" {{ $category->id==$earn->earncategory_id?"selected":"" }}>
                                                    {{ $category->name }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="earn_id" value="{{ $earn->id }}">
                                        <input type="text" name="details" class="form-control" value="{{ $earn->details }}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="amount" class="form-control" value="{{ $earn->amount }}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="date" class="form-control" value="{{ $earn->date }}">
                                        @if($errors->has("date"))
